...
<div class="container-fluid" style="margin-top:56px; background: url(./img/user/dashboard/1.jpg) no-repeat center; background-size: cover; background-attachment:fixed">
	<div class="row" style="padding: 32px 5% 12px 5%;">
		<div class="jumbotron shadow col-xl-4 col-lg-4 col-md-6 col-12 cus-op-85">
			<h1 class="display-4">星云模联</h1>
			<p class="lead">欢迎来到星云模联系统，这是您的主面板</p>
			<hr class="my-2" />
			<p>Giao！雅虎！火化！</p>
		</div>
		<div class=" col-xl-8 col-lg-8 col-md-6 col-12 cus-op-85">
	...
	<div class="row" style="padding: 12px 5% 12px 5%;">
		<div class=" col-xl-4 col-lg-4 col-md-4 col-12 cus-op-85">
			<div class="card shadow">
	...
	<div class="row" style="padding: 12px 5% 12px 5%;">
		<div class="col-xl-12 col-lg-12 col-md-12 col-12 cus-op-85">
			<div class="card shadow">
